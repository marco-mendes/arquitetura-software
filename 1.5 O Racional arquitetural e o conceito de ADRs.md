...
> **Conexão com o mapa arquitetural:** Em *1.0.1 — Visão Geral de Arquiteturas de Backend* foram identificadas quatro famílias de estilos, e em *1.1 — Estilos Arquiteturais de Backend* cada estilo foi detalhado com seus trade-offs. O ADR é o mecanismo que documenta **por que** o time escolheu um determinado estilo — e não outro — em um contexto específico. Escolher entre Microsserviços e uma Arquitetura em Camadas, ou entre APIs REST e Eventos, são exatamente o tipo de decisão que deve ser registrada como ADR.
