...
> **Conexão com o mapa arquitetural:** Em *[1.1 — Mapa e Estilos de Backend](1.1%20Mapa%20e%20Estilos%20de%20Backend.md)* foram apresentadas as quatro famílias arquiteturais e os trade-offs de cada estilo. O ADR é o mecanismo que documenta **por que** o time escolheu um determinado estilo — e não outro. Escolher entre Microsserviços e Camadas, ou entre APIs REST e Eventos, é exatamente o tipo de decisão que deve ser registrada como ADR.
