...
CONVERTIDOS = ("modulo-1-visao-geral", "modulo-2-apis", "modulo-3-servicos", "modulo-4-governanca", "modulo-5-eventos", "modulo-6-nuvem")
...
class WorkshopFilesTest(unittest.TestCase):
    ...
    def test_the_conversion_backlog_is_explicit(self):
        ...
        self.assertEqual([], pendentes, "todas as oficinas foram convertidas")
