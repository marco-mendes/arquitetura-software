...
### **Docker Swarm: Configuração Completa**
...
O Kubernetes é uma plataforma avançada para gerenciar contêineres em um ambiente distribuído. Este tutorial apresenta como rodar minimamente o MiniKube, uma instalação mínima Kubernetes para ambientes de desenvolvimento e provas de conceito.
