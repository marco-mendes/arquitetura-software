...
Imagine o ano de 2008. O Netflix, antes um humilde serviço de DVDs por correio, ousa sonhar com streaming. Mas seu sistema era um gigante de pedra: um monólito monolítico em Java, amarrado a um banco de dados Oracle centralizado. Tudo — autenticação, player, cobrança — estava entrelaçado. Quando um usuário pressionava "Play", o sistema inteiro tremia. Em noites de lançamento de séries, como Mad Men, o serviço entrava em colapso. Pior: qualquer mudança no código exigia horas de deploy, e uma única falha no módulo de cobrança derrubava até o player de vídeo.

#### O Despertar dos Arquitetos:
Em uma reunião tensa em Los Gatos, os engenheiros enfrentaram a realidade: o monólito era um inimigo da escala. Eles precisavam de uma revolução. Inspirados pelo conceito de microsserviços da Amazon, decidiram fatiar o gigante. Cada funcionalidade se tornaria um serviço independente, rodando em containers leves. Mas como convencer a liderança a investir em uma migração que levaria anos?
...
Em 2012, o monólito estava morto. Agora, 500+ microsserviços coexistiam. Cada equipe (recomendações, pagamento, catálogo) tinha autonomia absoluta. Exemplo: ao lançar o recurso "Perfis de Usuário", a equipe de UI não precisou coordenar com a de cobrança. O resultado? Novas features saíam em semanas, não meses.
...
* Chaos Gorilla: Derribava datacenters inteiros para testar redundância geográfica.
...
Smith, J. (2021). Spring Cloud Adoption in Fortune 500 Companies. Journal of Cloud Architecture, 12(3), 45-59.
