> **Acervo legado preservado.** Para o percurso atual da disciplina, consulte [Módulo 6 — Estudo de caso](docs/modulo-6-nuvem/estudo-de-caso.md) e o exercício de diagramação em [Módulo 6 — Exercícios](docs/modulo-6-nuvem/exercicios.md).
