### O Estilo Arquitetural de Pipes and Filters

> **Localização no mapa arquitetural:** Pipes and Filters pertence à **Família 3 — Integração e Comunicação** apresentada em *[1.1 — Mapa e Estilos de Backend](1.1%20Mapa%20e%20Estilos%20de%20Backend.md)*. Embora o pipeline possa rodar dentro de um único processo monolítico, o padrão é conceitualmente orientado ao fluxo de dados entre componentes independentes — o que o aproxima dos estilos de comunicação como APIs e Eventos.
