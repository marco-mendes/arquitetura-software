...
Um exemplo contrastante ajuda. Depois do evento de pedido, Crédito pode aprovar um limite e Notificação pode preparar um aviso; nenhuma reação precisa comandar a outra. Um processo de cancelamento de pedido, porém, talvez tenha que ordenar estorno de crédito, reposição de estoque e registro administrativo com regras de compensação. Um mediator torna essa coreografia visível. Chamar cada etapa de “orquestração” esconderia a diferença.
