...
5. [Casos reais](casos-reais.md): o LinkedIn mata o monólito Leo, congela o produto inteiro e inventa o Apache Kafka.
...
*Figura 5 — Reações independentes a um fato publicado. Fonte: curso.*
