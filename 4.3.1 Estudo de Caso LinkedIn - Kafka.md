> **Acervo legado preservado.** A versão canônica da disciplina, reconstruída a partir das fontes primárias, está em [Módulo 5 — Casos reais](docs/modulo-5-eventos/casos-reais.md).
