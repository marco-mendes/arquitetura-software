> **Acervo legado preservado.** A versão canônica deste caso, com as fontes primárias identificadas, está em [Módulo 5 — Casos reais](docs/modulo-5-eventos/casos-reais.md).
