> **Acervo legado preservado.** A versão canônica deste caso, enriquecida com os estudos de caso oficiais da AWS e com leitura crítica dos números divulgados, está em [Módulo 6 — Casos reais](docs/modulo-6-nuvem/casos-reais.md).
