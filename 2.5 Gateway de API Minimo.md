> **Acervo legado preservado.** Para o percurso atual da disciplina, consulte [Módulo 2 — Exemplo arquitetural](docs/modulo-2-apis/exemplo-arquitetural.md).

# Exemplo de Gateway de API
