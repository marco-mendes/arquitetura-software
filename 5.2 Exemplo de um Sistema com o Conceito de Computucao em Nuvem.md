> **Acervo legado preservado.** Para o percurso atual da disciplina, consulte [Módulo 6 — Exemplo arquitetural](docs/modulo-6-nuvem/exemplo-arquitetural.md).

## Exemplo de uma Arquitetura com o Estilo de Computação em Nuvem

Considere a figura abaixo.

<img width="1672" height="941" alt="image" src="https://github.com/user-attachments/assets/00237923-6329-4b53-bdc2-03a135c8a47c" />
