> **Acervo legado preservado.** Para o percurso atual da disciplina, consulte [Módulo 2 — Padrões e decisões](docs/modulo-2-apis/padroes-e-decisoes.md).

## A Agenda do Arquiteto para APIs

<img width="1024" height="1536" alt="agenda do arquiteto" src="https://github.com/user-attachments/assets/cf10adc2-d2a1-4a37-b95f-57d59151afaf" />
