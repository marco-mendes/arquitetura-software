> **Acervo legado preservado.** Estas questões foram reescritas e ancoradas em fontes primárias em [Módulo 3 — Casos reais](docs/modulo-3-servicos/casos-reais.md#leitura-guiada). A questão 4 desta versão cita um sistema chamado *AlgoX*, nome que não foi localizado em publicação técnica da Netflix.
