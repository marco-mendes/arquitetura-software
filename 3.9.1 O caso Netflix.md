> **Acervo legado preservado.** Este texto foi escrito em registro narrativo e não teve as afirmações verificadas contra fontes publicadas. A versão canônica da disciplina está em [Módulo 3 — Casos reais](docs/modulo-3-servicos/casos-reais.md).
