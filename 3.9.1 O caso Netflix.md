> **Acervo legado preservado.** Este texto foi escrito em registro narrativo e contém detalhes sem fonte verificável. A versão canônica, reconstruída a partir de material publicado pela Netflix e de artigo revisado por pares, está em [Módulo 3 — Casos reais](docs/modulo-3-servicos/casos-reais.md), que também registra o que aqui circula sem origem rastreável.
