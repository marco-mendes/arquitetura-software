...
* NServiceBus → Framework de mensageria distribuída que fornece endpoints e handlers para  - implementar um Mediator centralizado em arquiteturas orientadas a eventos. - [Documentação](https://particular.net/nservicebus)
...
* Google Workflows → Orquestrador de workflows no Google Cloud que coordena serviços e implementa o  padrão Mediator através de fluxos declarativos com controle de ordem, condições e compensações. - [Documentação](https://cloud.google.com/workflows/docs)
